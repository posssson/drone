/*
 * File: nouvelle_trajectoire_emxutil.c
 *
 ...
 * Return Type  : void
 */
void emxInit_real32_T1(emxArray_real32_T **pEmxArray, int b_numDimensions)
{
  emxArray_real32_T *emxArray;
  int i;
  *pEmxArray = (emxArray_real32_T *)malloc(sizeof(emxArray_real32_T));
...
/*
 * File trailer for nouvelle_trajectoire_emxutil.c
 *
 * [EOF]
 */
