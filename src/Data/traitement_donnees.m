...
hold on
plot(PID_decompose_tangage(debut:fin,2),'r')
plot(PID_decompose_tangage(debut:fin,3),'c')
title('Commande tangage')
legend('Kp','Ki','Kd');
subplot(2,1,2)
plot(PID_vit_decompose_tangage(debut:fin,1),'b')
hold on
plot(PID_vit_decompose_tangage(debut:fin,2),'r')
plot(PID_vit_decompose_tangage(debut:fin,3),'c')
title('Commande vit tangage')
legend('Kp','Ki','Kd');
...
figure
subplot(2,1,1)
plot(PID_decompose_roulis(debut:fin,1),'b')
hold on
plot(PID_decompose_roulis(debut:fin,2),'r')
plot(PID_decompose_roulis(debut:fin,3),'c')
title('Commande roulis')
legend('Kp','Ki','Kd');
subplot(2,1,2)
plot(PID_vit_decompose_roulis(debut:fin,1),'b')
hold on
plot(PID_vit_decompose_roulis(debut:fin,2),'r')
plot(PID_vit_decompose_roulis(debut:fin,3),'c')
title('Commande vit roulis')
legend('Kp','Ki','Kd');
